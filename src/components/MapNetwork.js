...
//             // console.log(locationArray);
//             console.log(this.props.currentConnections);
//             const devin = Promise.all(this.props.currentConnections.connections.map( (locationData)=>{
//             console.log('!!!locationData. location!!!!',locationData);
//             locationData.location = this.props.getLatLng(locationData.location.lat, locationData.location.lng)
//             console.log("Trying to clean daa, did this work?")
//             return locationData}))
//
//             // this.setState({locations: await devin})
//             // console.log(devin);
//             // console.log(this.state.locations);
//             // this.setState({isLoading: false})
//             // return await devin
